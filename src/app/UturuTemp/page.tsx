              ...
              <Grid templateColumns="repeat(2, 1fr)" gap={5} m={8}>
                ...
                <GridItem colSpan={2} mt={10}>
                  ...
                  >
                    ...
                    メンバー4人に加え、ライヴ・サポートを務める廣瀬謙介(gt)、山田宏也(エンヤコーラーズ/dr,per)、さらにはゲスト・ミュージシャンとして浮(vo)、下田開登(PICNIC
                    YOU/ rap)、マーティ・ホロベック(bass
                    ...
                    <Accordion allowToggle>
                      <AccordionItem>
                        ...
                        <AccordionPanel pb={4}>
                          ...
                          <Text fontSize="14px" fontFamily="japanese2" mt={1}>
                            　また、今作はバンドで初となる Dolby Atmos、360
                            Reality Audio
